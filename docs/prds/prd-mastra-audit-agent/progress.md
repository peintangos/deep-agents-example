...
| spec-004-critic-and-report | critic サブエージェントとレポート統合 | in-progress | | critic / reporter / agent.ts orchestration 実装済み (AUDIT_SYSTEM_PROMPT を 2 フェーズ構造に刷新、critic を subagents に登録)。残りは `.gitignore` / E2E |
