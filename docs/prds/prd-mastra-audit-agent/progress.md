...
| spec-007-skills-integration | Skills 統合 | in-progress | | `skills/audit/{license,security,maintenance,api-stability,community}/SKILL.md` を作成し、tests/skills-audit.test.ts で 26 ケースの形式契約を固定。残りは report/zenn-style skill / createAuditAgent 配線 / subagent 個別割当 / 段階的開示テスト |
