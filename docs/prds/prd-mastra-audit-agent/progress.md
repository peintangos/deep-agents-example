...
| spec-004-critic-and-report | critic サブエージェントとレポート統合 | in-progress | | critic サブエージェント (`src/subagents/critic.ts` + 7 tests) を追加。残りは reporter / agent.ts orchestration / .gitignore / E2E |
